...
When a JSON response content contains hypermedia links created with {spring-github-org}/spring-hateoas[Spring HATEOAS], you can verify the resulting links by using JsonPath expressions, as the following example shows:
...
When XML response content contains hypermedia links created with {spring-github-org}/spring-hateoas[Spring HATEOAS], you can verify the resulting links by using XPath expressions:
