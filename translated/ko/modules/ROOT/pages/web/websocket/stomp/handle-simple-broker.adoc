...
NOTE: Applications can also use dot-separated (rather than slash-separated) destinations. See xref:web/websocket/stomp/destination-separator.adoc[Dots as Separators].
