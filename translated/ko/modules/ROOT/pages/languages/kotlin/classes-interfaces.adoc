...
You can declare configuration classes as {kotlin-docs}/nested-classes.html[top level or nested but not inner], since the latter requires a reference to the outer class.
